        ...
        <ContentSection title="Contact Information">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <a href="mailto:info@loja.vuro.com.br" className="text-muted-foreground hover:text-primary transition-colors">info@loja.vuro.com.br</a>
        ...
        <ContentSection title="Frequently Asked Questions">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="warranty" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                All Vuro jewelry comes with a lifetime warranty against manufacturing defects. This includes free repairs for normal wear and tear, stone tightening, and professional cleaning.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="care" className="border border-border rounded-lg px-6">
              <AccordionTrigger className="text-left hover:no-underline">
                How should I care for my Vuro jewelry?
              </AccordionTrigger>
              <AccordionContent className="text-muted-foreground">
            ...
            <AccordionItem value="authentication" className="border border-border rounded-lg px-6">
              ...
              <AccordionContent className="text-muted-foreground">
                Every Vuro piece comes with a certificate of authenticity and is hallmarked. You can verify authenticity on our website using your unique piece number or contact our customer care team.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </ContentSection>
